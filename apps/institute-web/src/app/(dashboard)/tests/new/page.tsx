...
import { FlashcardEditor, type FlashcardEditorData } from '@/components/FlashcardEditor';
      ...
      <div className="space-y-4">
        {questions.map((q, qIdx) => (
          <div key={q.id} className="glass p-6">
            ...
            {/* FlashcardEditor — preview-first, click-to-edit */}
            <FlashcardEditor
              ...
              onChange={(d: FlashcardEditorData) => updateQ(qIdx, {
                text: d.text,
                options: d.options,
